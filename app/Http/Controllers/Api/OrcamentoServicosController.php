...
class OrcamentoServicosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request['adicionais']) {
            ...
            $itens = OrcamentoServico::with($with)->where('ativo', true);
        } else {
            $itens = OrcamentoServico::where('ativo', true);
        }
        ...
        if ($request['where']) {
            ...
            // } else {
            //     $itens = OrcamentoServico::where('id', 'like', '%');
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request, OrcamentoServico $orcamentoServico)
    {
        $iten = $orcamentoServico;
