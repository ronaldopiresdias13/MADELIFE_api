...
class MonitoramentoescalasController extends Controller
{
    ...
    {
        // $monitoramentoescala->escala;
        return Monitoramentoescala::find($monitoramentoescala->id);
    }
    public function getMonitoramentoById(Monitoramentoescala $monitoramentoescala)
    {
        // $monitoramentoescala->escala;
        $monitoramento = Monitoramentoescala::find($monitoramentoescala->id);
    ...
    {
        DB::transaction(function () use ($request, $monitoramentoescala) {
            $monitoramentoescala->escala_id  = $request->escala_id;
            $monitoramentoescala->data       = $request->data;
            $monitoramentoescala->hora       = $request->hora;
            $monitoramentoescala->pa         = $request->pa;
