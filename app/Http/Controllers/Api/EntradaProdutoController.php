...
class EntradaProdutoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request['adicionais']) {
            ...
            $itens = EntradaProduto::with($with)->where('ativo', true);
        } else {
            $itens = EntradaProduto::where('ativo', true);
        }
     ...
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  \App\EntradaProduto  $entradaProduto
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request, EntradaProduto $entradaProduto)
    {
        $iten = $entradaProduto;
    ...
    {
        DB::transaction(function () use ($request, $entradaProduto) {
