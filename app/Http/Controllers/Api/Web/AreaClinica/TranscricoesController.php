...
class TranscricoesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Transcricao::with(['ordemservico.orcamento.homecare.paciente.pessoa', 'ordemservico.orcamento.cliente.pessoa', 'profissional.pessoa', 'itensTranscricao.produto', 'itensTranscricao.horariomedicamentos'])
