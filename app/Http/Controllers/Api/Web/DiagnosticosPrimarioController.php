...
class DiagnosticosPrimarioController extends Controller
{
    ...
    public function update_diagnostico(DiagnosticoRequest $request){
        ...
        $diagnostico = DiagnosticoPil::where('flag','=','Primário')->where('id','=',$data['diagnostico_id'])->first();
    ...
    public function getDiagnostico($id)
    {
        ...
        $empresa_id = $user->pessoa->profissional->empresa_id;
        $diagnostico = DiagnosticoPil::where('flag','=','Primário')->where('id','=',$id)->first();
    ...
    public function delete_diagnostico($id)
    {
        ...
        $empresa_id = $user->pessoa->profissional->empresa_id;
        $diag = DiagnosticoPil::where('flag','=','Primário')->where('id','=',$id)->delete();
        return response()->json([
            'status' => true,
        ]);
    }
