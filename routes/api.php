...
Route::post('comentariosmedicao', 'Api\ComentariomedicaoController@store');
Route::get('comentariosmedicao/buscaComentariosPorIdMedicao/{medicao}', 'Api\ComentariomedicaoController@buscaComentariosPorIdMedicao');
