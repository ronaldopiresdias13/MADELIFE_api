...
Route::group([
    'prefix' => 'app/v3_1_0/auth'
], function () {
    Route::post('login', 'Api\App\v3_1_0\Auth\AuthController@login');
    Route::post('register', 'Api\App\v3_1_0\Auth\AuthController@register');
    Route::post('reset', 'Api\App\v3_1_0\Auth\AuthController@reset');
    Route::post('verificaCpfEmail', 'Api\App\v3_1_0\Auth\AuthController@verificaCpfEmail');

    /* ------------- Rotas Utilizando Token -------------*/
    Route::group(['middleware' => 'auth:api'], function () {
        Route::post('change', 'Api\App\v3_1_0\Auth\AuthController@change');
        Route::get('logout', 'Api\App\v3_1_0\Auth\AuthController@logout');
        // Route::get('user', 'Auth\AuthController@user');
    });
});
